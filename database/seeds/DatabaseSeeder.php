...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('empresas_usuarios')->delete();
        ...
        $permissions_user = [
            ...
            ['name' => 'credit-management', 'display_name' => 'Gestión crediticia',     'description' => 'Permite al usuario estándar la visualización de elementos de pago y morosidad'],
            ['name' => 'morosity',          'display_name' => 'Ver morosidad',          'description' => 'Permite al usuario estándar la visualización de elementos de pago y morosidad'],
